        ...
        public async static Task<byte[]> Encrypt(Session_Data session, string data_to_encrypt)
        {
            ...
            else
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    using (var authResponse = await httpClient.PostAsync(System_Path.AUTHENTICATION_API+"EncryptData", content))
                    {
        ...
        public async static Task<string> Decrypt(Session_Data session, byte[] data_to_decrypt)
        {
            ...
            else
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    using (var authResponse = await httpClient.PostAsync(System_Path.AUTHENTICATION_API+"DecryptData", content))
                    {
        ...
        public async static Task<List<Encrypted_Object>> EncryptList(Session_Data session, List<Decrypted_Object> list_to_encrypt)
        {
            ...
            else
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    using (var authResponse = await httpClient.PostAsync(System_Path.AUTHENTICATION_API+"EncryptDataList", content))
                    {
        ...
        public async static Task<List<Decrypted_Object>> DecryptList(Session_Data session, List<Encrypted_Object> list_to_decrypt)
        {
            ...
            else
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    using (var authResponse = await httpClient.PostAsync(System_Path.AUTHENTICATION_API+"DecryptDataList", content))
                    {
